...
class Inventario(tk.Frame):
    ...
    def widgets(self):
        ...
        lblframe_buscar = LabelFrame(self, text="Buscar", font="arial 14 bold", bg=estilos.COLORS['bg_primary'])
        ...
        lblframe_seleccion = LabelFrame(self, text='Seleccion', font="arial 12 bold", bg=estilos.COLORS['bg_primary'])
        ...
        # self.label3 = tk.Label(lblframe_seleccion, text='Costo-proveedor: ',font="arial 12 bold", bg=estilos.COLORS['bg_primary'])
        ...
        lblframe_botones = LabelFrame(self, text="Opciones", font="arial 14 bold", bg=estilos.COLORS['bg_primary'])
    ...
    def agregar_articulo(self):
        ...
        tk.Label(top, text="Articulos:", font="arial 12 bold", bg=estilos.COLORS['bg_primary']).place(x=20, y=20, width=80, height=25)
