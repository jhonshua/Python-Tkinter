...
class Clientes(tk.Frame):
    ...
    def widgets(self):
        ...
        self.nombre =  ttk.Entry(self.labelframe,  font=('Segoe UI', 11, 'bold') )
        self.nombre.place(x=10, y=50, width=220, height=40)

        lblcedula = tk.Label(self.labelframe, text="Cedula:", font=('Segoe UI', 11, 'bold'), bg=estilos.COLORS['bg_primary'])
        lblcedula.place(x=10,y=100)
        self.cedula =  ttk.Entry(self.labelframe,  font=('Segoe UI', 11, 'bold') )
        ...
        self.celular =  ttk.Entry(self.labelframe,  font=('Segoe UI', 11, 'bold') )
        self.celular.place(x=10, y=210, width=220, height=40 )

        lbldireccion = tk.Label(self.labelframe, text="Direccion:",font=('Segoe UI', 11, 'bold'),bg=estilos.COLORS['bg_primary'])
        lbldireccion.place(x=10,y=260)
        self.direccion =  ttk.Entry(self.labelframe,  font=('Segoe UI', 11, 'bold') )
        ...
        self.correo =  ttk.Entry(self.labelframe,  font=('Segoe UI', 11, 'bold') )
...
#--------------------------------------------------------------------------------- 
    ...
    def modificar(self):
        ...
        nombre_nuevo = tk.Entry(top_modificar, font=('Segoe UI', 11, 'bold'))
        nombre_nuevo.insert(0, nombre_actual)
        nombre_nuevo.grid(row=0, column=1, padx=10, pady=5)

        tk.Label(top_modificar, text="Cedula: ", font=('Segoe UI', 11, 'bold'), bg=estilos.COLORS['bg_primary']).grid(row=1, column=0, padx=10, pady=5)
        cedula_nuevo = tk.Entry(top_modificar, font=('Segoe UI', 11, 'bold'))
        ...
        celular_nuevo = tk.Entry(top_modificar, font=('Segoe UI', 11, 'bold'))
        celular_nuevo.insert(0, celular_actual)
        celular_nuevo.grid(row=2, column=1, padx=10, pady=5)

        tk.Label(top_modificar, text="Direccion: ", font=('Segoe UI', 11, 'bold'), bg=estilos.COLORS['bg_primary']).grid(row=3, column=0, padx=10, pady=5)
        direccion_nuevo = tk.Entry(top_modificar, font=('Segoe UI', 11, 'bold'))
        ...
        correo_nuevo = tk.Entry(top_modificar, font=('Segoe UI', 11, 'bold'))
        ...
        btn_guardar = tk.Button(top_modificar,bg="red", text="Eliminar cliente" , font=('Segoe UI', 11, 'bold'))
